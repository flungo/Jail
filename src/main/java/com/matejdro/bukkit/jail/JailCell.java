...
public class JailCell {
    ...
    /**
     * @param Name Name of the cell. Can be null if you don't want to specify
     * one.
     * @param JailName Name of the jail that contains that cell
     * @param Player Name of the player that is jailed inside that cell. Make it
     * empty string, if there is no such player.
     */
    ...
    /**
     * @return Name of the cell. It can be null or empty if cell does not have a
     * name.
     */
    ...
    /**
     * @return Location, where player gets teleported after being jailed in this
     * cell
     */
    public Location getTeleportLocation() {
        if (teleport.getWorld() == null && getJail() != null) {
            teleport.setWorld(getJail().getTeleportLocation().getWorld());
        }
        return teleport;
    }

    /**
     * Sets Location, where player gets teleported after being jailed in this
     * cell
     *
    ...
    /**
     * @return chest that belongs to this cell. Returns null if there is no such
     * chest.
     */
    public Chest getChest() {
        ...
        if (chest.getWorld() == null) {
            chest.setWorld(getJail().getTeleportLocation().getWorld());
        }
        if (chest.getBlock() == null || (chest.getBlock().getType() != Material.CHEST)) {
            return null;
        }
    ...
    public ArrayList<Sign> getSigns() {
        ...
        for (Location sign : signs) {
            ...
            if (sign.getWorld() == null) {
                sign.setWorld(getJail().getTeleportLocation().getWorld());
            }
     ...
     *
     * @param input name of the player. Use blank string if you want to clear
     * that field.
     */
