...
public class JailAPI {
     ...
     * @param jailName Name of the jail, where prisoner will be jailed. Use null
     * to let plugin select nearest jail.
     * @param reason Reason for jailing. Use null if you don't want to specify
     * reason.
     * @deprecated use jailPlayer(String playerName, int time, String jailName,
     * String cellName, String reason)
     */
    @Deprecated
    ...
    /**
     * Insert new jail zone into jail system. Useful for example when your
     * plugin creates its own jail zone.
     *
    ...
    /**
     * Insert new prisoner into jail system. Use if you want to jail someone
     * manually.
     *
