...
public class JailBlockListener implements Listener {
    ...
    public void onBlockBreak(BlockBreakEvent event) {
        ...
        if (jail == null || !jail.getSettings().getBoolean(Setting.EnableBlockDestroyProtection)) {
            return;
        }
        ...
        if (jail.getSettings().getList(Setting.BlockDestroyProtectionExceptions).contains(String.valueOf(event.getBlock().getTypeId() + ":" + event.getBlock().getData()))
                || jail.getSettings().getList(Setting.BlockDestroyProtectionExceptions).contains(String.valueOf(event.getBlock().getTypeId()))) {
            return;
        }
    ...
    public void onBlockPlace(BlockPlaceEvent event) {
        ...
        JailZone jail = JailZoneManager.getJail(event.getBlock().getLocation());
        if (jail == null || !jail.getSettings().getBoolean(Setting.EnableBlockPlaceProtection)) {
            return;
        }
        ...
        if (jail.getSettings().getList(Setting.BlockPlaceProtectionExceptions).contains(String.valueOf(event.getBlock().getTypeId() + ":" + event.getBlock().getData()))
                || jail.getSettings().getList(Setting.BlockPlaceProtectionExceptions).contains(String.valueOf(event.getBlock().getTypeId()))) {
            return;
        }
